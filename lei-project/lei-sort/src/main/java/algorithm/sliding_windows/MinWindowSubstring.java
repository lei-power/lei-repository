package algorithm.sliding_windows;
    ...
    public String minWindow(String s, String t) {
        ...
        while (end <= s.length()) {
            ...
            if (tCharFrequency.containsKey(newChar)) {
                ...
                if (subStrCharFrequency.get(newChar) <= tCharFrequency.get(newChar)) { charCount++; }
            }
            ...
            while (charCount == t.length() && start < end) {
                ...
                if (tCharFrequency.containsKey(removedChar)) {
                    ...
                    if (subStrCharFrequency.get(removedChar) < tCharFrequency.get(removedChar)) { charCount--; }
                }
