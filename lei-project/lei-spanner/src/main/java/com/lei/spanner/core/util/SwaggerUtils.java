...
public class SwaggerUtils {
    ...
    public static Docket getDocket(String groupName, String scanPackage, String title) {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName(groupName).apiInfo(apiInfo).useDefaultResponseMessages(false).select()
                //.apis(predicate)
                .apis(RequestHandlerSelectors.basePackage(scanPackage)).build().globalOperationParameters(pars);
    }
