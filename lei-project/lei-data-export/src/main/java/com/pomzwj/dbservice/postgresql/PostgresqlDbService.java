...
public class PostgresqlDbService extends AbstractDbService implements DbService {
    ...
    private void getTableColumnInfoByMultiThread(JdbcTemplate jdbcTemplate, List[] listArray, String userName)
            throws Exception {
    ...
    public void setColumnDataInfo(JdbcTemplate jdbcTemplate, List<DbTable> list, String executeSql, String dbName) {
        for (int j = 0; j < list.size(); j++) {
            ...
            List<Map<String, Object>> resultList = jdbcTemplate
                    .queryForList(executeSql, dbTable.getTableName(), dbName, dbTable.getTableName());
