  ...
  methods: {
    generateWord(sqlKind, exportFileType) {
      ...
      if (exportFileType == 'excel') {
        window.open(
            "/dbExport/v2/makeExcel?dbKind=" + sqlKind + "&ip=" + ip + "&port="
            + port + "&dbName=" + dataname + "&userName=" + username
            + "&password=" + password + "&exportFileType=" + exportFileType);
      } else if (exportFileType == 'word') {
        window.open(
            "/dbExport/v2/makeWord?dbKind=" + sqlKind + "&ip=" + ip + "&port="
            + port + "&dbName=" + dataname + "&userName=" + username
            + "&password=" + password + "&exportFileType=" + exportFileType);
      }
    ...
    barClick(sqlKind) {
      if (sqlKind == 'welcome') {
        ...
        this.sqlserverIconImg = ctx
            + "/assetss/images/v2/sqlserver-icon-unclick.png";
        this.postgresqlIconImg = ctx
            + "/assetss/images/v2/postgresql-icon-unclick.png";
        ...
        this.postgresqlBarStyle.background = "rgb(255,255,255)";
        //图片
        this.welcomeIconImg = ctx
            + "/assetss/images/v2/welcome-icon-unclick.png";
        ...
        this.mysqlIconImg = ctx + "/assetss/images/v2/mysql-icon-unclick.png";
        this.sqlserverIconImg = ctx
            + "/assetss/images/v2/sqlserver-icon-click.png";
        this.postgresqlIconImg = ctx
            + "/assetss/images/v2/postgresql-icon-unclick.png";
        ...
        this.sqlserverIconImg = ctx
            + "/assetss/images/v2/sqlserver-icon-unclick.png";
        this.postgresqlIconImg = ctx
            + "/assetss/images/v2/postgresql-icon-click.png";
    ...
    openMyWxQr() {
      let html = "<img style='width:300px;height: 300px;' src='" + ctx
          + "/assetss/images/v2/mywxqr.png'" + "/>";
    ...
    generateDocHtml(sqlKind) {
      ...
      window.open(
          "/dbExport/v2/viewDocHtml?dbKind=" + sqlKind + "&ip=" + ip + "&port="
          + port + "&dbName=" + dataname + "&userName=" + username
          + "&password=" + password);
    }
  }
