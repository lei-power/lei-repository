 ...
 * <p>
 * 案例说明：电商比价需求 1 同一款产品，同时搜索出同款产品在各大电商的售价; 2 同一款产品，同时搜索出本产品在某一个电商平台下，各个入驻门店的售价是多少
 * <p>
 * 出来结果希望是同款产品的在不同地方的价格清单列表，返回一个List<String> 《mysql》 in jd price is 88.05 《mysql》 in pdd price is 86.11 《mysql》 in taobao price is 90.43
 * <p>
 * 3 要求深刻理解 3.1 函数式编程 3.2 链式编程 3.3 Stream流式计算
 */
    ...
    public static List<String> getPriceByASync(List<NetMall> list, String productName) {
        return list
                ...
                .map(netMall -> CompletableFuture.supplyAsync(() -> String
                        .format(productName + " is %s price is %.2f", netMall.getMallName(),
                                netMall.calcPrice(productName))))
                .collect(Collectors.toList())
                .stream()
