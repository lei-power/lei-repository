...
//        copyContent(
//                path + "\\_sidebar.md",
//                path + "\\_sidebar_old_" + String.valueOf(new SimpleDateFormat("yyyyMMddHHmmss").format(new Date()))
//                        + ".md");
//
//        // 输出到目录文件
...
//        copyContent(
//                path + "\\content.json",
//                path + "\\content_old_" + String.valueOf(new SimpleDateFormat("yyyyMMddHHmmss").format(new Date()))
//                        + ".json");
//
//        // 输出到目录文件
...
//                    list.add(new MDClass(Math.random() + "", child.getName(), url, "2", mdClasses, child.getParent()
//                                                                                                        .replace(path, "")
//                                                                                                        .replace("\\", "/"), child.getName()));
...
//                    list.add(new MDClass(
//                            Math.random() + "", label, url, "1", mdClasses, child.getParent().replace(path, "")
//                                                                                 .replace("\\", "/"), mdUrl));
//
//                }
//            }
