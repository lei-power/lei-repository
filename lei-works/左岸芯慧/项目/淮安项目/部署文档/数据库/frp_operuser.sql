...
(
  ...
  ROW_FORMAT = DYNAMIC;
INSERT INTO `frp_operuser`.`tbl_operate_subject` (`id`, `operate_traceability_config_id`, `default_conf_flag`, `operate_name`, `operate_key`,
                                                  `operate_logo_url1`, `operate_logo_url2`, `operate_favicon_url`, `product_name`, `login_url`, `home_url`,
                                                  `operate_status`, `show_pick_check_code_flag`, `enable_add_company`, `enable_register`, `domain_name`,
                                                  `copyright_notes`, `app_download_photo_url`, `login_banner`, `service_terms_type`, `privacy_terms_type`,
                                                  `create_time`, `update_time`, `hidden_menu_type`, `show_menu_type`, `mini_program_show_flag`,
                                                  `mini_program_name`, `mini_program_img_url`, `suyuan_doc_url1`, `suyuan_doc_url2`, `suyuan_doc_url3`,
                                                  `help_video_url1`, `help_video_url2`, `contact_weixin`, `contact_phone`, `contact_qq`,
                                                  `contact_weixin_img`, `suyuan_demo_url`, `farmshow_demo_url`, `app_logo_url`, `rank_open_flag`,
                                                  `free_farm_num`, `free_user_num`, `charge_farm_num`, `charge_user_num`, `flagship_farm_num`,
                                                  `flagship_user_num`, `max_send_expert_num`, `max_reply_expert_num`)
VALUES (1, 2, 1, '左岸芯慧F', NULL, 'https://zuoan-test.oss-cn-hangzhou.aliyuncs.com/zuoan-test/4a4f9798-814d-44dd-86cd-547d297b32fa.png',
        'https://zuoan-test.oss-cn-hangzhou.aliyuncs.com/zuoan-test/9636dd92-dc1b-49ba-9b84-fc6aed3369f9.png',
        'https://zuoan-test.oss-cn-hangzhou.aliyuncs.com/zuoan-test/45db3a1d-796a-461c-8464-8433fec48863.jfif', '神农口袋1', '1312',
        'https://testf.snkoudai.com/', 1, 0, 1, 1, 'testf.snkoudai.com', 'Copyright © 2010-2021 Zaxh Inc. All Rights Reserved.',
        'https://zuoan-test.oss-cn-hangzhou.aliyuncs.com/zuoan-test/170e67f9-1651-4dc6-83b7-e40197844c21.jpg', NULL, 1, 2, '2019-06-12 14:33:43',
        '2022-10-11 17:34:09', 536576, 261949, 1, '啦啦啦',
        'https://zuoan-test.oss-cn-hangzhou.aliyuncs.com/zuoan-test/de179b1f-eeb3-456b-8a42-bb4f6e78c255.jpg',
        'http://opertest.zaxhiot.com/opera-management/detail', 'https://www.kancloud.cn/zaxh/suyuanma/1200215', 'https://www.baidu.com/',
        'https://www.baidu.com/', 'https://mp.weixin.qq.com/s/qjn6K3dIoqY8bi4yJ3Lxug', '2222222222', '111111111111', '154569354',
        'https://zuoan-test.oss-cn-hangzhou.aliyuncs.com/zuoan-test/57898065-d58f-436b-839c-fcb642becf83.png',
        'https://showtest.snkoudai.com/ywym/#/home/root/11770000000', 'https://www.baidu.com/',
        'https://zuoan-test.oss-cn-hangzhou.aliyuncs.com/zuoan-test/e0422d6b-ad92-40df-865f-ec5f2cf50af5.png', 1, 2, 4, 20, 2000, 3000, 4000, NULL, NULL);
...
INSERT INTO `frp_operuser`.`tbl_operate_traceability_config` (`id`, `config_name`, `page_title`, `config_desc`, `logo1`, `logo2`, `trace_name`,
                                                              `trace_url`, `trace_mall_name`, `trace_mall_url`, `wx_share_title`, `wx_share_desc`,
                                                              `create_by`, `create_time`, `update_by`, `update_time`, `home_url`, `home_url_click_flag`,
                                                              `top_banner_img_url`, `top_logo_url`)
VALUES (2, '官方模板', '页面标题页面标题页面标题页面标题', '', '',
        'https://zuoan-test.oss-cn-hangzhou.aliyuncs.com/zuoan-test/7d99e7bf-03bc-4f90-a1fa-73f31c176e75.png', '溯源介绍', 'https://test.snkoudai.com/',
        '溯源商城', 'https://www.baidu.com/', '&&goodsName&& - 好食材不怕公开', '看得见溯源匠心，吃得出健康安心', 1, '2019-06-17 15:34:08', 1,
        '2020-07-27 16:44:22', 'https://www.snkoudai.com/', 1,
        'https://zuoan-test.oss-cn-hangzhou.aliyuncs.com/zuoan-test/b8a8f3d2-862d-4b9d-b049-f40a85cd561e.jpg',
        'https://zuoan-test.oss-cn-hangzhou.aliyuncs.com/zuoan-test/dcb60488-fbce-4e51-94bf-6d467f1a1644.png');
INSERT INTO `frp_operuser`.`tbl_operate_traceability_config` (`id`, `config_name`, `page_title`, `config_desc`, `logo1`, `logo2`, `trace_name`,
                                                              `trace_url`, `trace_mall_name`, `trace_mall_url`, `wx_share_title`, `wx_share_desc`,
                                                              `create_by`, `create_time`, `update_by`, `update_time`, `home_url`, `home_url_click_flag`,
                                                              `top_banner_img_url`, `top_logo_url`)
VALUES (4, '熊猫溯源', '熊猫溯源为您呈现优质农产品',
        '我是&&goodsName&&。我被农民伯伯摘下来后，被浩浩荡荡发往苏宁小店，我是全批次共&&boundBarcodeTotalNum&&个包装中的第&&pickBindCurNum&&个，很期待与您见面。',
        'https://zuoan-test.oss-cn-hangzhou.aliyuncs.com/zuoan-test/23fda609-f75c-4fae-8fad-1d4348c2e519.png',
        'https://zuoan-test.oss-cn-hangzhou.aliyuncs.com/zuoan-test/feec241c-a3fa-45d4-bbcb-27b61ae7baf2.png', '什么是熊猫溯源',
        'https://mp.weixin.qq.com/s/ZxdAhEvyzrKiYlfEF05Eog', '', '', '&&goodsName&& - 1食品安全看得见',
        '1您有权利知道您吃的食物是如何生产出来的，在哪生产的，由谁生产', 2, '2019-06-24 19:30:04', 1, '2020-07-22 15:16:32', '123', 0,
        'https://zuoan-test.oss-cn-hangzhou.aliyuncs.com/zuoan-test/90e1c4cc-01bf-4f2e-804f-1ffbb5e78825.png',
        'https://zuoan-test.oss-cn-hangzhou.aliyuncs.com/zuoan-test/ce58f2cf-1291-4585-8a53-9110ac0d04db.png');
