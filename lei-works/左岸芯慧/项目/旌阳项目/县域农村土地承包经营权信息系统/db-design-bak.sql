...
# (
#     `id`   bigint(20)  NOT NULL AUTO_INCREMENT COMMENT '主键',
#     `lxdm` varchar(20) NOT NULL COMMENT '类型代码',
#     `lxmc` varchar(50) NOT NULL COMMENT '类型名称',
#     PRIMARY KEY (`id`) USING BTREE,
#     UNIQUE KEY `uk_lxdm` (`lxdm`) USING BTREE
# ) ENGINE = InnoDB
#   DEFAULT CHARSET = utf8mb4
...
#     `id`            bigint(20)  NOT NULL AUTO_INCREMENT COMMENT '主键',
#     `fbfbm`         varchar(14) NOT NULL COMMENT '发包方代码',
#     `cbdkxx_cursor` varchar(5)  NOT NULL COMMENT '承包地块信息游标（5位系列顺序码）',
#     `create_time`   datetime DEFAULT NULL COMMENT '创建时间',
#     `update_time`   datetime DEFAULT NULL COMMENT '更新时间',
#     PRIMARY KEY (`id`) USING BTREE
# ) ENGINE = InnoDB
...
#     `id`          bigint(20)  NOT NULL AUTO_INCREMENT COMMENT '主键',
#     `fbfbm`       varchar(14) NOT NULL COMMENT '发包方代码',
#     `cbf_cursor`  varchar(4)  NOT NULL COMMENT '承包方游标(4位系列顺序码)',
#     `create_time` datetime DEFAULT NULL COMMENT '创建时间',
#     `update_time` datetime DEFAULT NULL COMMENT '更新时间',
#     PRIMARY KEY (`id`) USING BTREE
# ) ENGINE = InnoDB
...
#     `id`          bigint(20)  NOT NULL AUTO_INCREMENT COMMENT '主键',
#     `fbfbm`       varchar(14) NOT NULL COMMENT '发包方代码',
#     `lzht_cursor` varchar(4)  NOT NULL COMMENT '流转合同游标(4位系列顺序码)',
#     `create_time` datetime DEFAULT NULL COMMENT '创建时间',
#     `update_time` datetime DEFAULT NULL COMMENT '更新时间',
#     PRIMARY KEY (`id`) USING BTREE
# ) ENGINE = InnoDB
...
#     `id`          bigint(20)  NOT NULL AUTO_INCREMENT COMMENT '主键',
#     `fbfbm`       varchar(14) NOT NULL COMMENT '发包方代码',
#     `srf_cursor`  varchar(4)  NOT NULL COMMENT '受让方游标(4位系列顺序码)',
#     `create_time` datetime DEFAULT NULL COMMENT '创建时间',
#     `update_time` datetime DEFAULT NULL COMMENT '更新时间',
#     PRIMARY KEY (`id`) USING BTREE
# ) ENGINE = InnoDB
